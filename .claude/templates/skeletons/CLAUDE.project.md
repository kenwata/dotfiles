...
- 終了時: `HANDOFF.md` を**全体上書き**する(追記しない)。仕様解釈・設計からの逸脱・ユーザー決定があれば `docs/decisions.md` に1行追記する。最後に上書きした `HANDOFF.md`(と `docs/decisions.md`)をコミットする — 未コミットのまま終えると次セッションの最初のタスクコミットに混入する(`TODO.md` があれば §0 の終了手順にも従う)
