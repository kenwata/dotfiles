...
4. **検証(コールドスタートテスト)**: 「着地物(design + TODO.md + HANDOFF.md)だけを読んだ新セッションが、会話履歴なしで `T<n>` に着手できるか」をセルフチェックし、会話にしか無い前提が残っていれば着地物へ書き足す。あわせて①ポインタ実在(design ↔ TODO.md の相互参照)②タスクIDの重複なし③§0 の保持、を機械的に確認する。
