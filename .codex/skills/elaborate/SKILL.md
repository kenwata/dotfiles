...
- Do not create or edit `TODO.md`. Write the design document, update `plan.md` / `docs/decisions.md` / `docs/architecture.md` only as the canonical command specifies, and set the next action in `HANDOFF.md` to `/breakdown docs/design/<slug>.md`.
