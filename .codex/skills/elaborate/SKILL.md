...
- Write `前提と確かめ方` and, for plans with more than one stage, `段階` under the approach section as the design skeleton defines. Verify every premise that reading or a shell command can check before committing the design; fix the design if one fails.
