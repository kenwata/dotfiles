...
# Drop the delivery cursor for this session. The cursor only has meaning
# while the same session_id can be re-armed; the session is over now.
rm -f "$RUN_DIR/cursor.$SESSION_ID"
